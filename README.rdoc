...
* configatron.cas.email_attribute - LDAP attribute containing user's e-mail. Example: 'mail' or 'UserPrincipalName'
* configatron.cas.name_attribute - LDAP attribute containing user's username. Example: 'nickname' or 'Name'
* configatron.cas.avatar_enabled - Specifies whether avatars should be consumed and provided to Discourse.
* configatron.cas.avatar_url_attribute - LDAP attribute containing user's photo. Example: 'jpegPhoto'
